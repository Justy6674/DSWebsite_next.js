-- Phase 2: Fix RLS policies for security hardening
...
-- Fix website_crawls table - require authentication
...
-- Only allow authenticated admin users to manage website crawls
CREATE POLICY "Admin users can manage website crawls" 
...
CREATE POLICY "Admin users can manage crawled pages" 
...
-- Add user_id column to conversations to fix the RLS policies
