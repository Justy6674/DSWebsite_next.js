-- Create the trigger on blog_posts table to automatically update sitemap
...
-- Also ensure we have the ping function for search engines
...
-- Update the main trigger function to also ping search engines
...
BEGIN
  ...
  -- Also ping search engines about the update
