export const locationContent = {
  ...
  melbourne: {
    ...
    localInfo: "Melbourne's café culture and foodie scene can make weight loss challenging. Our program helps Melburnians navigate dining out while achieving their health goals, whether you're in trendy Fitzroy or family-friendly Frankston.",
    testimonial: {
