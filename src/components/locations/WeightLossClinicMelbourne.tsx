...
export default function WeightLossClinicMelbourne() {
  ...
  return (
    <>
      <Head>
        <title>Weight Loss Clinic Melbourne | $45 Affordable Holistic Telehealth | Downscale</title>
        <meta name="description" content="Affordable holistic weight loss clinic serving Melbourne. $45 consultations with Justin Black, Nurse Practitioner. Whole-person care approach - not a massive clinic. Kind, evidence-based programs. Book online today." />
        <meta name="keywords" content="weight loss clinic melbourne, weight loss clinic near me melbourne, weight loss clinic fitzroy, weight loss clinic st kilda, weight loss clinic richmond, weight loss clinic south yarra, weight loss clinic carlton, affordable consultationed weight loss melbourne, medicare weight loss doctor melbourne, online weight loss consultation melbourne, telehealth weight loss melbourne" />
        <link rel="canonical" href="https://www.downscale.com.au/weight-loss-clinic-melbourne" />
        
        <meta property="og:title" content="Weight Loss Clinic Melbourne | $45 Affordable Holistic Care | Book Online" />
        <meta property="og:description" content="Affordable holistic weight loss clinic serving Melbourne. $45 consultations with Justin Black, Nurse Practitioner. Whole-person care - kind, evidence-based treatment. Not a massive clinic." />
        <meta property="og:url" content="https://www.downscale.com.au/weight-loss-clinic-melbourne" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "MedicalClinic",
            "name": "Downscale Weight Loss Clinic - Online Weight Loss Clinic Melbourne",
            "description": "Professional telehealth weight loss clinic serving Melbourne with telehealth consultations and online appointments",
              ...
              <div className="text-center mb-12">
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <h1 className="heading-beach">
                    Weight Loss Clinic <span className="heading-beach">Melbourne</span>
                  </h1>
                </div>
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Professional telehealth weight loss support for Melbourne residents. Consultations from $45 — Medicare-eligible patients receive instant rebates 
            ...
            <div className="container mx-auto max-w-4xl">
              ...
              <div className="rounded-lg overflow-hidden shadow-lg">
                <iframe 
                  ...
                  title="Downscale Weight Loss Clinic Melbourne service area"
                  className="w-full"
                />
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <p>✓ Melbourne CBD & Inner Suburbs</p>
                    <p>✓ Eastern Suburbs & Bayside</p>
                    <p>✓ Northern Suburbs</p>
                    <p>✓ Western Suburbs</p>
                    <p>✓ Southeastern Suburbs</p>
                    <p>✓ Greater Melbourne Region</p>
                  </CardContent>
                </Card>
                
                <Card>
                  <CardHeader>
                    <CardTitle>Why Choose Downscale Melbourne?</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    ...
                    <p>✓ Melbourne-based support team</p>
                  </CardContent>
                </Card>
              </div>
          ...
          <section className="py-16 px-4 bg-primary/5">
            <div className="container mx-auto max-w-4xl text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Melbourne's most caring weight loss clinic is just a click away
              </p>
              <Button 
                onClick={() => handleBooking('initial')}
                size="lg"
