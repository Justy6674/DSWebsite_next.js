...
export default function WeightLossClinicSunshineCoast() {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:description" content="Affordable holistic weight loss clinic serving Sunshine Coast. $45 consultations with Justin Black, Nurse Practitioner. Whole-person care - kind, evidence-based treatment. Not a massive clinic." />
        <meta property="og:url" content="https://www.downscale.com.au/weight-loss-clinic-sunshine-coast" />
        ...
        <div className="min-h-screen bg-background">
              ...
              <div className="text-center mb-12">
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <h1 className="heading-beach">
                    Weight Loss Clinic <span className="heading-beach">Sunshine Coast</span>
                  </h1>
                </div>
          ...
          <section className="py-12 px-4 bg-muted/30">
            <div className="container mx-auto max-w-4xl">
              <h2 className="text-2xl font-bold mb-6 text-center">Our Sunshine Coast Service Area</h2>
              <div className="rounded-lg overflow-hidden shadow-lg">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d227748.3825058093!2d152.95987!3d-26.6500!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b93a9d7f3e1e1e1%3A0x5017d681632bfc0!2sSunshine%20Coast%20QLD!5e0!3m2!1sen!2sau!4v1234567890"
                  width="100%"
                  height="450"
                  style={{border:0}}
                  ...
                  title="Downscale Weight Loss Clinic Sunshine Coast service area"
                  className="w-full"
                />
              </div>
              <p className="text-center text-sm text-muted-foreground mt-4">
                Telehealth service available across all Sunshine Coast suburbs • No travel required
              </p>
            </div>
          </section>

          {/* Sunshine Coast Specific Content */}
          <section className="py-16 px-4">
            <div className="container mx-auto max-w-4xl">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-center heading-beach">
                Serving All Sunshine Coast via Telehealth
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <p>✓ Noosa & Noosa Heads</p>
                    <p>✓ Maroochydore & Cotton Tree</p>
                    <p>✓ Caloundra & Kings Beach</p>
                    <p>✓ Nambour & Hinterland</p>
                    <p>✓ Coolum & Peregian Beach</p>
                    <p>✓ All Sunshine Coast Suburbs</p>
                  </CardContent>
                </Card>
                
                <Card>
                  <CardHeader>
                    <CardTitle>Why Choose Downscale Sunshine Coast?</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    <p>✓ Perfect for coastal lifestyle</p>
                    <p>✓ No Brisbane commute required</p>
                    <p>✓ Same quality care as major cities</p>
                    <p>✓ Prescription delivery to coast</p>
                    <p>✓ Flexible scheduling for coastal living</p>
                    <p>✓ Understanding of Queensland climate needs</p>
                  </CardContent>
                </Card>
              </div>
          ...
          <section className="py-16 px-4 bg-primary/5">
            <div className="container mx-auto max-w-4xl text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Sunshine Coast's most caring weight loss clinic is just a click away
              </p>
              <Button 
                onClick={() => handleBooking('initial')}
                size="lg"
