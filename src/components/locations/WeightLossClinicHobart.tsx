...
export default function WeightLossClinicHobart() {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:description" content="Affordable holistic weight loss clinic serving Hobart. $45 consultations with Justin Black, Nurse Practitioner. Whole-person care - kind, evidence-based treatment. Not a massive clinic." />
        <meta property="og:url" content="https://www.downscale.com.au/weight-loss-clinic-hobart" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "MedicalClinic",
            "name": "Downscale Weight Loss Clinic - Hobart Weight Loss Clinic",
            "description": "$45 maximum out-of-pocket weight loss clinic serving Hobart with telehealth consultations for Medicare-eligible patients",
        ...
        <div className="min-h-screen bg-background">
              ...
              <div className="text-center mb-12">
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <h1 className="heading-beach">
                    Weight Loss Clinic <span className="heading-beach">Hobart</span>
                  </h1>
                </div>
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Professional telehealth weight loss support for Tasmania residents. Consultations from $45 — Medicare-eligible patients receive instant rebates 
          ...
          <section className="py-12 px-4 bg-muted/30">
            <div className="container mx-auto max-w-4xl">
              <h2 className="text-2xl font-bold mb-6 text-center">Our Hobart Service Area</h2>
              <div className="rounded-lg overflow-hidden shadow-lg">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d95684.37648391827!2d147.32470!3d-42.8821!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b15e8b3b3e1e1f%3A0x5017d681632bfc0!2sHobart%20TAS!5e0!3m2!1sen!2sau!4v1234567890"
                  width="100%"
                  height="450"
                  style={{border:0}}
                  ...
                  title="Downscale Weight Loss Clinic Hobart service area"
                  className="w-full"
                />
              </div>
              <p className="text-center text-sm text-muted-foreground mt-4">
                Telehealth service available across all Tasmania • No travel required
              </p>
            </div>
          </section>

          {/* Hobart Specific Content */}
          <section className="py-16 px-4">
            <div className="container mx-auto max-w-4xl">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-center heading-beach">
                Serving All Tasmania via Telehealth
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <p>✓ Hobart & Greater Hobart</p>
                    <p>✓ Launceston & Northern Tasmania</p>
                    <p>✓ Devonport & North West Coast</p>
                    <p>✓ Burnie & Coastal Areas</p>
                    <p>✓ Eastern Tasmania (St Helens, Swansea)</p>
                    <p>✓ All Remote Tasmanian Communities</p>
                  </CardContent>
                </Card>
                
                <Card>
                  <CardHeader>
                    <CardTitle>Why Choose Downscale Tasmania?</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    <p>✓ Perfect for island lifestyle</p>
                    <p>✓ No mainland travel required</p>
                    <p>✓ Same quality care as major cities</p>
                    <p>✓ Prescription delivery to Tasmania</p>
                    <p>✓ Understanding of Tasmanian healthcare needs</p>
                    <p>✓ Specialist support without leaving island</p>
                  </CardContent>
                </Card>
              </div>
          ...
          <section className="py-16 px-4 bg-primary/5">
            <div className="container mx-auto max-w-4xl text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Tasmania's most caring weight loss clinic is just a click away
              </p>
              <Button 
                onClick={() => handleBooking('initial')}
                size="lg"
