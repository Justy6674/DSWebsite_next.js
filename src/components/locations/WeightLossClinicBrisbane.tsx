...
export default function WeightLossClinicBrisbane() {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:description" content="Affordable holistic weight loss clinic serving Brisbane. $45 consultations with Justin Black, Nurse Practitioner. Whole-person care - kind, evidence-based treatment. Not a massive clinic." />
        <meta property="og:url" content="https://www.downscale.com.au/weight-loss-clinic-brisbane" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "MedicalClinic",
            "name": "Downscale Weight Loss Clinic - Brisbane Weight Loss Clinic",
            "description": "$45 maximum out-of-pocket weight loss clinic serving Brisbane with telehealth consultations for Medicare-eligible patients",
      ...
      <Layout>
        <div className="min-h-screen bg-background">
              ...
              <div className="text-center mb-12">
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <h1 className="heading-beach">
                    Weight Loss Clinic <span className="heading-beach">Brisbane</span>
                  </h1>
                </div>
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Professional telehealth weight loss support for Brisbane residents. Consultations from $45 — Medicare-eligible patients receive instant rebates 
          ...
          <section className="py-12 px-4 bg-muted/30" aria-label="Brisbane service area map">
            <div className="container mx-auto max-w-4xl">
              <h2 className="text-2xl font-bold mb-6 text-centre">Our Brisbane Service Area</h2>
              <div className="rounded-lg overflow-hidden shadow-lg">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d226834.01094279726!2d153.00846645!3d-27.470125!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b91579aac93d233%3A0x402a35af3deaf40!2sBrisbane%20QLD!5e0!3m2!1sen!2sau!4v1234567890"
                  width="100%"
                  height="450"
                  style={{border:0}}
                  ...
                  title="Downscale Weight Loss Clinic Brisbane service area"
                  className="w-full"
                />
              </div>
              <p className="text-centre text-sm text-muted-foreground mt-4">
                Telehealth service available across all Brisbane suburbs • No travel required
              </p>
            </div>
          </section>
          ...
          <section className="py-16 px-4">
            <div className="container mx-auto max-w-4xl">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-centre heading-beach">
                Serving All Brisbane Areas via Telehealth
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <p>✓ Brisbane CBD & Inner City</p>
                    <p>✓ Northside & Northern Suburbs</p>
                    <p>✓ Southside & Southern Suburbs</p>
                    <p>✓ Eastern Suburbs & Bayside</p>
                    <p>✓ Western Suburbs</p>
                    <p>✓ Greater Brisbane Region</p>
                  </CardContent>
                </Card>
                
                <Card>
                  <CardHeader>
                    <CardTitle>Why Choose Downscale Brisbane?</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    ...
                    <p>✓ Brisbane-based support team</p>
                  </CardContent>
                </Card>
              </div>
          ...
          <section className="py-16 px-4 bg-primary/5">
            <div className="container mx-auto max-w-4xl text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Brisbane's most caring weight loss clinic is just a click away
              </p>
              <Button 
                onClick={() => handleBooking('initial')}
                size="lg"
