...
export default function WeightLossClinicRockhampton() {
  ...
  return (
    <>
      <Head>
        <title>Weight Loss Clinic Rockhampton | Online Virtual Medicare Consultations</title>
        <meta name="description" content="Rockhampton telehealth weight loss clinic with Nurse Practitioner care. Consultations from only $45 with instant Medicare rebate processing for Rockhampton residents. Professional weight management support." />
        <meta name="keywords" content="weight loss clinic rockhampton, rockhampton weight loss clinic, telehealth weight loss clinic rockhampton, medicare weight loss clinic rockhampton, online weight management rockhampton" />
        <link rel="canonical" href="https://www.downscale.com.au/weight-loss-clinic-rockhampton" />
        
        <meta property="og:title" content="Weight Loss Clinic Rockhampton | Professional Telehealth Medicare Consultations" />
        <meta property="og:description" content="Professional telehealth weight loss clinic offering telehealth consultations. Consultations from only $45 with instant Medicare rebate processing for Rockhampton residents." />
        <meta property="og:url" content="https://www.downscale.com.au/weight-loss-clinic-rockhampton" />
        ...
        <meta name="twitter:title" content="Weight Loss Clinic Rockhampton | Professional Telehealth Medicare" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "name": "Downscale Weight Loss Clinic - Weight Loss Clinic Rockhampton",
        ...
        <div className="min-h-screen bg-background">
              ...
              <div className="text-center mb-12">
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <h1 className="heading-beach">
                    Weight Loss Clinic <span className="heading-beach">Rockhampton</span>
                  </h1>
                </div>
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Professional telehealth weight loss support for Rockhampton residents. Consultations from $45 — Medicare-eligible patients receive instant rebates 
          ...
          <section className="py-12 px-4 bg-muted/30">
            <div className="container mx-auto max-w-4xl">
              <h2 className="text-2xl font-bold mb-6 text-center">Our Rockhampton Service Area</h2>
              <div className="rounded-lg overflow-hidden shadow-lg">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d115632.87264891763!2d150.51360!3d-23.3781!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b93a9d7f3e1e1e1%3A0x5017d681632bfc0!2sRockhampton%20QLD!5e0!3m2!1sen!2sau!4v1234567890"
                  width="100%"
                  height="450"
                  style={{border:0}}
                  ...
                  title="Downscale Weight Loss Clinic Rockhampton service area"
                  className="w-full"
                />
              </div>
              <p className="text-center text-sm text-muted-foreground mt-4">
                Telehealth service available across all Rockhampton & Capricorn Region • No travel required
              </p>
            </div>
          </section>
          ...
          <section className="py-16 px-4">
            <div className="container mx-auto max-w-4xl">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-center heading-beach">
                Serving Rockhampton & Capricorn Region via Telehealth
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <p>✓ Rockhampton CBD</p>
                    <p>✓ North Rockhampton</p>
                    <p>✓ Yeppoon</p>
                    <p>✓ Gracemere</p>
                    <p>✓ Capricorn Region</p>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>Why Choose Downscale Rockhampton?</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-2">
          ...
          <section className="py-16 px-4 bg-primary/5">
            <div className="container mx-auto max-w-4xl text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Rockhampton's most caring weight loss clinic is just a click away
              </p>
              <Button 
                onClick={() => handleBooking('initial')}
                size="lg"
