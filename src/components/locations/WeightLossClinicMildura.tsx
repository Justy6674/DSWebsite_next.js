...
export default function WeightLossClinicMildura() {
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold" style={{ color: '#f7f2d3', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.7)' }}>
                Weight Loss Clinic <span style={{ color: '#f7f2d3' }}>Mildura</span>
              </h1>
            </div>
            <p className="text-xl md:text-2xl max-w-3xl mx-auto" style={{ color: '#f8fafc' }}>
              Professional telehealth weight loss support for Mildura and the Sunraysia region. Consultations from $45 with Medicare rebates.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-12">
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <h3 className="font-semibold">Sunraysia Healthcare</h3>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <h3 className="font-semibold">No Border Travel</h3>
                  <p className="text-sm text-muted-foreground">Skip Adelaide trips</p>
                </CardContent>
              </Card>
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-muted-foreground">Border community care</p>
                </CardContent>
              </Card>
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-muted-foreground">Cross-border health</p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <Card>
                ...
                <CardContent className="space-y-2">
                  <p>✓ Mildura & Red Cliffs</p>
                  <p>✓ Robinvale & Swan Hill</p>
                  <p>✓ Ouyen & Murrayville</p>
                  <p>✓ Wentworth NSW border</p>
                  <p>✓ Sunraysia irrigation district</p>
                  <p>✓ Murray River communities</p>
                </CardContent>
              </Card>

              <Card>
                <CardHeader>
                  <CardTitle>Why Choose Downscale Mildura?</CardTitle>
                </CardHeader>
                <CardContent className="space-y-2">
                  <p>✓ No 5+ hour drives to Melbourne</p>
                  <p>✓ Cross-border health understanding</p>
                  <p>✓ Same quality care as metro clinics</p>
                  <p>✓ Prescription delivery available</p>
                  <p>✓ Rural lifestyle accommodation</p>
            ...
            <div className="bg-primary/5 rounded-lg p-8 text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Expert weight loss care for the Murray River region.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  onClick={() => handleBooking('initial')}
        ...
        <section className="py-16 px-4 bg-primary/5">
          <div className="container mx-auto max-w-4xl text-center">
            <h2 className="text-3xl font-bold mb-4" style={{ color: '#f7f2d3' }}>
              Expert Weight Loss Care for the Border
            </h2>
            <p className="text-xl text-muted-foreground mb-8">
              Sunraysia's dedicated telehealth weight loss clinic
            </p>
            <Button
              onClick={() => handleBooking('initial')}
              size="lg"
            ...
            <p className="text-sm text-muted-foreground mt-4">
              Border-focused care • No travel required • Medicare rebates available
            </p>
          </div>
        </section>
      </div>
