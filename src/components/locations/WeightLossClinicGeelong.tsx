...
export default function WeightLossClinicGeelong() {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:description" content="Affordable holistic weight loss clinic serving Geelong. $45 consultations with Justin Black, Nurse Practitioner. Whole-person care - kind, evidence-based treatment. Not a massive clinic." />
        <meta property="og:url" content="https://www.downscale.com.au/weight-loss-clinic-geelong" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "MedicalClinic",
            "name": "Downscale Weight Loss Clinic - Geelong Weight Loss Clinic",
            "description": "$45 maximum out-of-pocket weight loss clinic serving Geelong with telehealth consultations for Medicare-eligible patients",
        ...
        <div className="min-h-screen bg-background">
              ...
              <div className="text-center mb-12">
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <h1 className="heading-beach">
                    Weight Loss Clinic <span className="heading-beach">Geelong</span>
                  </h1>
                </div>
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Professional telehealth weight loss support for Geelong and regional Victoria residents. Consultations from $45 — Medicare-eligible patients receive instant rebates 
                  with experienced healthcare professionals. No Melbourne traffic - consult from home.
                </p>
              </div>
          ...
          <section className="py-12 px-4 bg-muted/30">
            <div className="container mx-auto max-w-4xl">
              <h2 className="text-2xl font-bold mb-6 text-center">Our Geelong Service Area</h2>
              <div className="rounded-lg overflow-hidden shadow-lg">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d101632.87264891763!2d144.36030!3d-38.1499!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad15e8b3b3e1e1f%3A0x5017d681632bfc0!2sGeelong%20VIC!5e0!3m2!1sen!2sau!4v1234567890"
                  width="100%"
                  height="450"
                  style={{border:0}}
                  ...
                  title="Downscale Weight Loss Clinic Geelong service area"
                  className="w-full"
                />
              </div>
              <p className="text-center text-sm text-muted-foreground mt-4">
                Telehealth service available across all Geelong & Southwestern Victoria • No travel required
              </p>
            </div>
          </section>

          {/* Geelong Specific Content */}
          <section className="py-16 px-4">
            <div className="container mx-auto max-w-4xl">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-center heading-beach">
                Serving Geelong & Southwestern Victoria via Telehealth
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <p>✓ Geelong & Bellarine Peninsula</p>
                    <p>✓ Ballarat & Central Highlands</p>
                    <p>✓ Warrnambool & Great Ocean Road</p>
                    <p>✓ Colac & Otway Region</p>
                    <p>✓ Surf Coast (Torquay, Lorne)</p>
                    <p>✓ All Southwestern Victoria</p>
                  </CardContent>
                </Card>
                
                <Card>
                  <CardHeader>
                    <CardTitle>Why Choose Downscale Geelong?</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    <p>✓ No Melbourne commute required</p>
                    <p>✓ Understand regional lifestyle needs</p>
                    <p>✓ Same quality care as metropolitan</p>
                    <p>✓ Prescription delivery to Geelong</p>
                    <p>✓ Flexible scheduling for regional work</p>
                    <p>✓ Geelong-based understanding</p>
                  </CardContent>
                </Card>
              </div>
          ...
          <section className="py-16 px-4 bg-primary/5">
            <div className="container mx-auto max-w-4xl text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Geelong's most caring weight loss clinic is just a click away
              </p>
              <Button 
                onClick={() => handleBooking('initial')}
                size="lg"
