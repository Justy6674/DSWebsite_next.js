...
export default function WeightLossClinicCentralCoast() {
  ...
  return (
    <Layout>
      <div className="min-h-screen bg-background">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold" style={{ color: '#f7f2d3', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.7)' }}>
                Weight Loss Clinic <span style={{ color: '#f7f2d3' }}>Central Coast</span>
              </h1>
            </div>
            <p className="text-xl md:text-2xl max-w-3xl mx-auto" style={{ color: '#f8fafc' }}>
              Professional telehealth weight loss support for Central Coast residents. Consultations from $45 — Medicare-eligible patients receive instant rebates.
            </p>
          </div>
        ...
        {/* Google Maps Section */}
        <section className="py-12 px-4 bg-muted/30" aria-label="Central Coast service area map">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-2xl font-bold mb-6 text-center">Our Central Coast Service Area</h2>
            <div className="rounded-lg overflow-hidden shadow-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d425988.7515451847!2d151.2509765!3d-33.4308!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b73f1b8c0f0b0b0%3A0x0!2sCentral%20Coast%20NSW!5e0!3m2!1sen!2sau!4v1234567890"
                width="100%"
                height="450"
                style={{border:0}}
                ...
                title="Downscale Weight Loss Clinic Central Coast service area"
                className="w-full"
              />
            </div>
            <p className="text-center text-sm text-muted-foreground mt-4">
              Telehealth service available across all Central Coast suburbs • No travel required
            </p>
          </div>
        </section>
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-center" style={{ color: '#f7f2d3' }}>
              Serving All Central Coast Areas via Telehealth
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <Card>
                ...
                <CardContent className="space-y-2">
                  <p>✓ Gosford & Surrounds</p>
                  <p>✓ Wyong & Tuggerah</p>
                  <p>✓ Terrigal & Avoca Beach</p>
                  <p>✓ The Entrance & Bateau Bay</p>
                  <p>✓ Woy Woy & Umina Beach</p>
                  <p>✓ All Central Coast LGA</p>
                </CardContent>
              </Card>

              <Card>
                <CardHeader>
                  <CardTitle>Why Choose Downscale Central Coast?</CardTitle>
                </CardHeader>
                <CardContent className="space-y-2">
                  <p>✓ No Pacific Highway traffic delays</p>
                  ...
                  <p>✓ Regional healthcare understanding</p>
                </CardContent>
              </Card>
            </div>
        ...
        <section className="py-16 px-4 bg-primary/5">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Central Coast's most caring weight loss clinic is just a click away
            </p>
            <Button
              onClick={() => handleBooking('initial')}
              size="lg"
