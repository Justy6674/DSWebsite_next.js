...
export default function WeightLossClinicGoldCoast() {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:description" content="Affordable holistic weight loss clinic serving Gold Coast. $45 consultations with Justin Black, Nurse Practitioner. Whole-person care - kind, evidence-based treatment. Not a massive clinic." />
        <meta property="og:url" content="https://www.downscale.com.au/weight-loss-clinic-gold-coast" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "MedicalClinic",
            "name": "Downscale Weight Loss Clinic - Gold Coast Weight Loss Clinic",
            "description": "$45 maximum out-of-pocket weight loss clinic serving Gold Coast with telehealth consultations for Medicare-eligible patients",
            ...
            "areaServed": [
              ...
              {"@type": "Place", "name": "Surfers Paradise"},
              {"@type": "Place", "name": "Southport"},
              {"@type": "Place", "name": "Burleigh Heads"},
              {"@type": "Place", "name": "Robina"},
              {"@type": "Place", "name": "Broadbeach"},
              {"@type": "Place", "name": "Palm Beach"}
            ],
      ...
      <Layout>
        <div className="min-h-screen bg-background">
              ...
              <div className="text-center mb-12">
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <h1 className="heading-beach">
                    Weight Loss Clinic <span className="heading-beach">Gold Coast</span>
                  </h1>
                </div>
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Professional telehealth weight loss support for Gold Coast residents. Consultations from $45 — Medicare-eligible patients receive instant rebates 
          ...
          {/* Gold Coast Specific Content */}
          {/* Google Maps Section - CRITICAL FOR LOCAL SEO */}
          <section className="py-12 px-4 bg-muted/30" aria-label="Gold Coast service area map">
            <div className="container mx-auto max-w-4xl">
              <h2 className="text-2xl font-bold mb-6 text-centre">Our Gold Coast Service Area</h2>
              <div className="rounded-lg overflow-hidden shadow-lg">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113350.89847474867!2d153.31498085!3d-28.0172727!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b910433ce9ce3f3%3A0x402a35af3deaf40!2sGold%20Coast%20QLD!5e0!3m2!1sen!2sau!4v1234567890"
                  width="100%"
                  height="450"
                  style={{border:0}}
                  ...
                  title="Downscale Weight Loss Clinic Gold Coast service area"
                  className="w-full"
                />
              </div>
              <p className="text-centre text-sm text-muted-foreground mt-4">
                Telehealth service available across all Gold Coast suburbs • No travel required
              </p>
            </div>
          </section>
          ...
          <section className="py-16 px-4">
            <div className="container mx-auto max-w-4xl">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-centre heading-beach">
                Serving All Gold Coast Areas via Telehealth
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <p>✓ Surfers Paradise & Broadbeach</p>
                    <p>✓ Southport & Main Beach</p>
                    <p>✓ Burleigh Heads & Palm Beach</p>
                    <p>✓ Robina & Varsity Lakes</p>
                    <p>✓ Nerang & Pacific Pines</p>
                    <p>✓ Greater Gold Coast Region</p>
                  </CardContent>
                </Card>
                
                <Card>
                  <CardHeader>
                    <CardTitle>Why Choose Downscale Gold Coast?</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    ...
                    <p>✓ Gold Coast-based support team</p>
                  </CardContent>
                </Card>
              </div>
          ...
          <section className="py-16 px-4 bg-primary/5">
            <div className="container mx-auto max-w-4xl text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Gold Coast's most caring weight loss clinic is just a click away
              </p>
              <Button 
                onClick={() => handleBooking('initial')}
                size="lg"
