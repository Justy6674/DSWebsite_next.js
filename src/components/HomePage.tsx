  ...
  return (
    <Layout>
      ...
      <div 
        ...
        style={{
          backgroundImage: 'linear-gradient(to bottom, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.6)), image-set(url(/hero-family-sunset.webp) type("image/webp"), url(/hero-family-sunset-mobile.webp) type("image/webp"))',
