...
import { ArrowLeft, Download, Calculator, Book, Play, ExternalLink, Users } from 'lucide-react';
      ...
      <div className="bg-slate-800 border-b border-slate-700">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-[#f8fafc] mb-2">Nutrition Pillar 🥗</h1>
